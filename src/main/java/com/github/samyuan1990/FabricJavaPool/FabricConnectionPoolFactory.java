...
import com.github.samyuan1990.FabricJavaPool.Pool.FabricSDKPool;
...
public class FabricConnectionPoolFactory {
    ...
    public static GenericObjectPool<FabricConnection> getGatewayPool(String userName, String channel) {
        return new FabricGatewayPool(userName, channel);
    }

    public static GenericObjectPool<FabricConnection> getSDKPool(User appUser, String channel) {
        return new FabricSDKPool(appUser, channel);
    }
